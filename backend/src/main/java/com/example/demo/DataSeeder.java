...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (courseRepository.count() == 0) {
            ...
            c1.setButtonText("立刻體驗");
            c1.setButtonStyle("outline");
            
            // 對應 courses.ts 的 Course 1 Syllabus
            // 包含: u1, u2, u3
            String syllabus1 = "[" +
                "{" +
                    "\"id\": \"c1\", " +
            ...
            c2.setButtonText("立刻購買");
            c2.setButtonStyle("solid");
            
            // 對應 courses.ts 的 Course 2 Syllabus (完整 7 章)
            String syllabus2 = "[" +
                "{" +
                ...
                "}," +
                "{" +
                    "\"id\": \"ch4\", \"title\": \"70% 自動化：行為驅動開發 (BDD)\", \"date\": \"2025/11/17\", " +
                    "\"units\": [" +
                ...
                "}," +
                "{" +
                    "\"id\": \"ch5\", \"title\": \"60% 自動化：指令集架構之可執行規格\", \"date\": \"2025/12/08\", " +
                    "\"units\": [" +
                ...
                "}," +
                "{" +
                    "\"id\": \"ch6\", \"title\": \"50% 自動化：為企業打造專屬 BDD Master Agent\", \"date\": \"2026/12/15\", " +
                    "\"units\": [" +
                ...
                "}," +
                "{" +
                    "\"id\": \"ch7\", \"title\": \"40% 自動化：超 AI 化\", \"date\": \"2026/02/01\", " +
                    "\"units\": [" +
            ...
            System.out.println("--- 課程資料初始化完成 (v3: 完整課綱) ---");
        }
    }
}